...
** Add a short description of Movie Magic Grpc Client here. **
...
1. http://localhost:3000/: Movie Magic Grpc Client
...
? Which workspace should this go to? apps/movie-magic-grpc-client
